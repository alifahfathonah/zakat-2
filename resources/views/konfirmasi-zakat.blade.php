		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-xs-12 col-sm-1 align-right">
                <a title="Rubah Data" class="btn btn-success btn-circle-lg waves-effect waves-circle waves-float col-xs-1" href="editzakat.php?idtrans={{ base64_encode($transaksi->id) }}"><i class="material-icons">border_color</i></a>
              </div>
              <div class="col-xs-12 col-sm-1 align-right">
